...
# args = {
#     weights: 'custom/yolov3-tiny_final.weights',
#     classes: 'custom/objects.names',
#     config: 'custom/yolov3-tiny.cfg'
# }
class Args:
    def __init__(self):
        self.weights = 'custom/yolov3-tiny_final.weights'
        self.classes = 'custom/yolov3-tiny.names'
        self.config = 'custom/yolov3-tiny.cfg'
...
test_file = "custom/test_final.txt" 
